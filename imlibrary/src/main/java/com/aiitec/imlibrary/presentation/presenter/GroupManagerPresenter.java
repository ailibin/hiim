...
import com.aiitec.imlibrary.presentation.viewfeatures.GroupManageView;
...
public class GroupManagerPresenter {
     ...
     *
     * @param groupId 群组ID
     * @param identifier 邀请的好友
     * @param callBack 回调
     */
    public static void modifyGroupOwner(String groupId, String identifier, TIMCallBack  callBack){
        TIMGroupManagerExt.getInstance().modifyGroupOwner(groupId, identifier, callBack);
    }
