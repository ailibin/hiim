...
import com.aiitec.widgets.pickerview.listener.OnDismissListener;
import com.aiitec.widgets.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews(int backgroudId) {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.pickerview_base_layout, null, false);
            //设置界面的背景为透明
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.photo_dialog_style);
