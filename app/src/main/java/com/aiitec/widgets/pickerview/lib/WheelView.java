package com.aiitec.widgets.pickerview.lib;
...
import com.aiitec.widgets.pickerview.adapter.WheelAdapter;
import com.aiitec.widgets.pickerview.listener.OnItemSelectedListener;
import com.aiitec.widgets.pickerview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    ScheduledExecutorService mExecutor = newSingleThreadScheduledExecutor();
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        //默认大小
        textSize = getResources().getDimensionPixelSize(R.dimen.pickerview_text_size);
    ...
    private void measureTextWidthHeight() {
        ...
        for (int i = 0; i < adapter.getItemsCount(); i++) {
            String s1 = "";
            if (adapter.getItem(i) instanceof Region) {
                Region region = (Region) adapter.getItem(i);
                s1 = getContentText(region.getName());
            } else {
                s1 = getContentText(adapter.getItem(i));
            }
