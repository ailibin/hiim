...
import com.aiitec.imlibrary.presentation.presenter.SplashPresenter;
import com.aiitec.imlibrary.presentation.viewfeatures.SplashView;
import com.aiitec.imlibrary.tlslibrary.activity.HostLoginActivity;
import com.aiitec.imlibrary.tlslibrary.service.TLSService;
import com.aiitec.imlibrary.tlslibrary.service.TlsBusiness;
import com.aiitec.imlibrary.ui.NotifyDialog;
...
public class SplashActivity extends FragmentActivity implements SplashView, TIMCallBack {
    ...
    public void navToHome() {
        ...
        Log.e("ailibin", "id: " + UserInfo.getInstance().getId() +
                "  userSig: " + UserInfo.getInstance().getUserSig());
