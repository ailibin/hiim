 ...
 */
package com.dreamtobe.kpswitch;
...
public interface IPanelConflictLayout {
     ...
     * Keyboard->Panel
     *
     * @see com.dreamtobe.kpswitch.util.KPSwitchConflictUtil#showPanel(android.view.View)
     */
    void handleShow();
     ...
     * Panel->Keyboard
     *
     * @see com.dreamtobe.kpswitch.util.KPSwitchConflictUtil#showKeyboard
     */
    void handleHide();
     ...
     * @see com.dreamtobe.kpswitch.handler.KPSwitchPanelLayoutHandler#resetToRecommendPanelHeight
     * @see com.dreamtobe.kpswitch.util.KeyboardUtil#getValidPanelHeight(android.content.Context)
     */
